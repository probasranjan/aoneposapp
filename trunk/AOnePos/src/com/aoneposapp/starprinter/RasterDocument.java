...
public class RasterDocument
{
    ...
    {
    	Log.v("RasterDocument", speed+" "+endOfPageBehaviour+" "+topMargin+" "+pageLength);
    	mSpeed = speed;
    ...
    public byte[] BeginDocumentCommandData()
    {
        ...
        Log.v(""+getPrintSpeed(), ""+mPageLength+"  "+mLeftMargin+" "+mRightMargin);
        Log.v(""+getPrintSpeed(), ""+SetEndOfPageModeCommand(getEndOfDocumentBehaviour())+"  "+
        SetEndOfDocModeCommand(getEndOfDocumentBehaviour())+" "+TopMarginCommand(mTopMargin));
