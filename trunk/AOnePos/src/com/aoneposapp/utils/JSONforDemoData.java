...
public class JSONforDemoData extends AsyncTask<String, Void, String> {
	...
	public static String connect(String url) {
		DatabaseForDemo sqlA1 = new DatabaseForDemo(curContext);
		SQLiteDatabase sqliteDatabaseA1 = sqlA1.getWritableDatabase();
		...
		try {
			...
			while (rowIter.hasNext()) {
				...
				if (p <= 200) {
					...
					sqliteDatabaseA1.insert(DatabaseForDemo.INVENTORY_TABLE,
							null, contentValues);
					contentValues.clear();
