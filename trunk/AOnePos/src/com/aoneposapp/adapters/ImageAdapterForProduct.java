...
//	public ImageAdapterForProduct(Context c, ArrayList<String> itemno, ArrayList<String> itemname, ArrayList<String> pricecharge, ArrayList<String> stock, ArrayList<String> desc2, ArrayList<String> vendor)
//	{
//		this.c = c;
////		this.itemno = itemno;
...
//	}
	...
	public ImageAdapterForProduct(Context c, ArrayList<HashMap<String, String>> arrayList)
	{
		this.c = c;
...
//		vendortext.setText(vendor.get(position));
		itemnotext.setText(arrayList.get(position).get("itemno"));
		final String itemnoval = arrayList.get(position).get("itemno");
		itemnametext.setText(arrayList.get(position).get("itemname"));
		pricetext.setText(arrayList.get(position).get("pricecharge"));
		stocktext.setText(arrayList.get(position).get("stock"));
		desc2text.setText(arrayList.get(position).get("desc2"));
		vendortext.setText(arrayList.get(position).get("vendor"));
