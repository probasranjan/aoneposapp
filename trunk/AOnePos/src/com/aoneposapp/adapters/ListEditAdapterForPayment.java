...
public class ListEditAdapterForPayment extends CursorAdapter{
Context context;
int i=2; int z=0;
private OnWidgetItemClicked listener;
private int[] colors = new int[] { 197214228, 170190206 };
	@SuppressWarnings("deprecation")
	public ListEditAdapterForPayment(Context context, Cursor c) {
		super(context, c);
		  ...
		  final TextView showvalue = (TextView)v.findViewById(R.id.showvalue);
			...
			delete.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(listener != null) listener.onEditClickedforpayment(v, text.getText().toString(),text.getTag().toString());
				}
			});
			edit.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Log.e("tagdd", text.getText().toString()+"....."+listener);
					if(listener != null) listener.onDeleteClickedforpayment(v, text.getText().toString());
				}
			});
	}
...
public interface OnWidgetItemClicked{
		...
		void onDeleteClickedforpayment(View v, String string);
