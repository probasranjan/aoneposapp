...
public class ReportItemAdapter extends CursorAdapter{
	Context context;
	int i=2; int z=0;
	private int[] colors = new int[] { 197214228, 170190206 };
		@SuppressWarnings("deprecation")
		public ReportItemAdapter(Context context, Cursor c) {
			super(context, c);
		...
		public void bindView(View v, Context arg1, Cursor arg2) {
			// TODO Auto-generated method stub
			  ...
			  String tv2 = arg2.getString(5);
			  String tv6 = arg2.getString(6);
			  String tv5 = arg2.getString(7);
			  String tv8 = arg2.getString(10);
			  String tv7 = arg2.getString(9);
